...
| Project Name | Technology Stack | Description |
| --- | --- | --- |
| [Telegram RSS Bot on Cloudflare Workers](https://github.com/lxl66566/Telegram-RSS-Bot-on-Cloudflare-Workers) | Typescript | Telegram RSS Bot runs on Cloudflare Workers<br/>托管在 Cloudflare 的 RSS 订阅 bot  |
...
| [Mars-Bot-rs](https://github.com/lxl66566/Mars-Bot-rs) | Rust | Detect repeated images.<br/>检测重复图像，你火星了.jpg |
